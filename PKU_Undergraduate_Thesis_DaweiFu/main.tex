...
\pkuthssinfo{
	...
	ctitle = {CMS实验中大动量H$\to$WW的标记技术开发及物理应用},
	...
	ckeywords = {大动量希格斯粒子，X$\to$WW共振态，喷注标记技术，超出标准模型},
	ekeywords = {Boosted Higgs,\ X$\to$WW resonance,\ Jet-tagging technique,\ Beyond Standard-Model}
}
